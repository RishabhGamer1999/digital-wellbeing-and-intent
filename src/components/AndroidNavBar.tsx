...
const AndroidNavBar = () => {
  ...
  return (
    <div className="h-10 flex items-center justify-center gap-16 bg-card border-t border-border shrink-0">
      ...
      <button
        onClick={() => navigate("/")}
        className="w-5 h-5 rounded-full border-2 border-muted-foreground hover:border-foreground transition-colors"
      />
