      ...
      <AnimatePresence>
        {showToast && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed top-20 left-1/2 -translate-x-1/2 z-50 bg-card border border-high-tension/30 rounded-full px-4 py-2.5 flex items-center gap-3 shadow-lg glow-danger"
          >
